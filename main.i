...
extern ASTROBUTTON astbtns[4];
extern WEAPON weapons[2];
extern CREWMATE crewmates[2];
...
void game() {
    ...
    drawRect(36, 9, 40, 20, 0);
    drawString(2, 9, crewStr, ((31) | (0)<<5 | (0)<<10));
...
void goToStart() {
    ...
    drawString(48, 70, titleStr, ((31) | (0)<<5 | (0)<<10));
    char *str = "Press SELECT to play";
    drawString(60, 100, str, ((31) | (31)<<5 | (31)<<10));
    state = START;
...
void goToPause() {
    fillScreen(0);
    char *str = "Paused";
    drawString(100, 100, str, ((31) | (31)<<5 | (31)<<10));
    state = PAUSE;
...
void goToWin() {
    ...
    drawString(50, 80, str1, ((31) | (0)<<5 | (0)<<10));
    char *str2 = "all the crewmates >:)";
    drawString(50, 100, str2, ((31) | (0)<<5 | (0)<<10));
    state = WIN;
...
void goToLose() {
    ...
    drawString(30, 80, str1, ((31) | (31)<<5 | (31)<<10));
    char *str2 = "the crewmates voted you off :(";
    drawString(30, 100, str2, ((31) | (31)<<5 | (31)<<10));
    state = LOSE;
